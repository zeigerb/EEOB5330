...
The number of possible genotypes increase following the triangle numbers (1, 3, 6, 10), so the number of possible genotypes (g) in a system with n alleles is g = n \* (n+1) / 2
